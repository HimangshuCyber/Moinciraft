...
function up(){
    if(player_y>=0){
        ...
        console.log("Player's new position is: Y=" + player_y + ", X=" + player_x);
        console.log("The y cordinate changed by " + block_height)
...
function left(){
    if(player_x>=0){
        ...
        console.log("Player's new position is: Y=" + player_y + ", X=" + player_x);
        console.log("The x cordinate changed by " + block_width);
        canvas.remove(player_object);
        player_update();
    }
}
